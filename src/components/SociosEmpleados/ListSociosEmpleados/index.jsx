...
import { faArrowDownLong, faBars } from "@fortawesome/free-solid-svg-icons";
...
function ListSociosEmpleados(props) {
    ...
    const modificacionSocio = (content) => {
        console.log("Modificación socio activado"); // Añade este console.log
    ...
    const eliminacionSocio = (content) => {
        console.log("Eliminación socio activado"); // Añade este console.log
