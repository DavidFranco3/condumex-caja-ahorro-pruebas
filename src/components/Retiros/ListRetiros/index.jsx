...
function ListRetiros(props) {
    const { listRetiros, history, location, setRefreshCheckLogin, rowsPerPage, setRowsPerPage, page, setPage, noTotalRetiros } = props;
        ...
        <>
            <Container fluid>
                <DataTable
                    ...
                    pagination
                    paginationServer
                    paginationTotalRows={noTotalRetiros}
