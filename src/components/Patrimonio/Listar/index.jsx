...
function Listar(props) {
    const { listPatrimonios, history, location, setRefreshCheckLogin, rowsPerPage, setRowsPerPage, page, setPage, noTotalPatrimonios } = props;
        ...
        <>
            <Container fluid>
                <DataTable
                    ...
                    pagination
                    paginationServer
                    paginationTotalRows={noTotalPatrimonios}
