...
import { cambiaEstadoSocioEspecial } from "../../../api/sociosEspeciales";

function ModificaEstadoSocioEspecial (props) {
    ...
    const onSubmit = (e) => {
        ...
        try {
            cambiaEstadoSocioEspecial(id, dataTemp).then(response => {
                const { data } = response;
...
export default ModificaEstadoSocioEspecial;
