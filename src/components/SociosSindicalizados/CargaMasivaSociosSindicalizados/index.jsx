...
const CargaMasivaSociosSindicalizados = ({ setShowModal, history }) => {
        ...
        const handleSubmit = async (evt) => {
                ...
                for (const { ficha, nombre, correo } of dataFile) {
                        ...
                        await registraSocioSindicalizado(dataSindicalizados);
...
export default CargaMasivaSociosSindicalizados;
