...
export async function registraMovimientoSaldos(data) {
    ...
    return await axios.post(API_HOST + ENDPOINTRegistroMovimientosSaldos, data, config);
}

// Listar todos los movimientos de saldos
export async function listarMovimientoSaldos(params) {
    const config = {
        headers: {
            'Accept': 'application/json',
            'Content-Type': 'application/json',
    ...
    return await axios.get(API_HOST + ENDPOINTListarMovimientosSaldos, config);
}
...
export async function totalxTipoMovimientosSaldos(dato) {
    ...
    return await axios.get(API_HOST + ENDPOINTTotalxTipoMovimientosSaldos + `/?tipo=${dato}`, config);
}
...
export async function listarPaginacionMovimientoSaldos(pagina, limite) {
    ...
    return await axios.get(API_HOST + ENDPOINTListarPaginandoMovimientosSaldos + `/?pagina=${pagina}&&limite=${limite}`, config);
}

// Listar paginando los movimientos de saldos, indicando el tipo
export async function listarPaginacionMovimientosSaldosxTipo(pagina, limite, tipo) {
    const config = {
        headers: {
            'Accept': 'application/json',
            'Content-Type': 'application/json',
    ...
    return await axios.get(API_HOST + ENDPOINTListarPaginandoMovimientoSaldosxTipo + `/?pagina=${pagina}&&limite=${limite}&&tipo=${tipo}`, config);
}
...
export async function obtenerFolioActualMovimientoSaldos() {
    ...
    return await axios.get(API_HOST + ENDPOINTObtenerFolioMovimientosSaldos, config);
}
...
export async function obtenerMovimientoSaldos(id) {
    ...
    return await axios.get(API_HOST + ENDPOINTObtenerMovimientosSaldos + `/${id}`, config);
}
...
export async function obtenerDatosMovimientoSaldos(dato) {
    ...
    return await axios.get(API_HOST + ENDPOINTObtenerxFichaMovimientosSaldos + `/${dato}`, config);
}
...
export async function eliminaMovimientoSaldos(id) {
    ...
    return await axios.delete(API_HOST + ENDPOINTEliminarMovimientosSaldos + `/${id}`, config);
}
...
export async function actualizaMovimientoSaldos(id, data) {
    ...
    return await axios.put(API_HOST + ENDPOINTActualizarMovimientosSaldos + `/${id}`, data, config);
}
