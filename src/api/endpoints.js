...
export const ENDPOINTObtenerRendimientoxFichaSaldos = '/rendimientos/obtenerRendimientoxFicha';
...
export const ENDPOINTActualizarTotalPrestamos = '/prestamos/actualizarTotalPrestamo';
...
export const ENDPOINTListarPaginandoAbonosxTipo =
  '/abonos/listarPaginandoxTipo';
...
export const ENDPOINTObtenerNombrexFichaSociosEmpleados = '/empleados/obtenerNombrexFicha';
...
export const ENDPOINTObtenerSindicalizadosByNombre =
  ...
  export const ENDPOINTEliminarSindicalizadosMasivo = '/sindicalizados/eliminarMasivo';
...
export const ENDPOINTObtenerEspecialesByNombre =
  ...
  export const ENDPOINTEliminarEspecialesMasivo = '/sociosEspeciales/eliminarMasivo';
